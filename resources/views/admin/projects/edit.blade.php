            ...
            <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="mining_type" name="mining_type" class="w-full bg-dark-primary border border-gray-700 text-gray-200 rounded-lg px-4 py-2.5 focus:border-gold focus:ring-gold/20">
                        ...
                        <option value="Timah" {{ old('mining_type', $project->mining_type) === 'Timah' ? 'selected' : '' }}>Timah</option>
                        <option value="Pasir" {{ old('mining_type', $project->mining_type) === 'Pasir' ? 'selected' : '' }}>Pasir</option>
                ...
                <div>
                    ...
                    <input type="text" id="permit_status" name="permit_status" value="{{ old('permit_status', $project->permit_status) }}" class="w-full bg-dark-primary border border-gray-700 text-gray-200 rounded-lg px-4 py-2.5 focus:border-gold focus:ring-gold/20">
                ...
                <div class="sm:col-span-2">
                    ...
                    <img src="{{ asset('storage/' . $project->cover_image) }}" class="h-32 rounded-lg object-cover">
                </div>
                @endif
                <div class="sm:col-span-2">
